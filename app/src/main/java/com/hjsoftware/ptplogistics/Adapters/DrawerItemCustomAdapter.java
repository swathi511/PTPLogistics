...
public class DrawerItemCustomAdapter extends ArrayAdapter<NavigationData> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ImageView imageViewIcon = (ImageView) listItem.findViewById(com.hjsoftware.ptplogistics.R.id.imageViewIcon);
        TextView textViewName = (TextView) listItem.findViewById(com.hjsoftware.ptplogistics.R.id.textViewName);
        ...
        {
            textViewName.setTextColor(Color.parseColor("#F9A825"));
