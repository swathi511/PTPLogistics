...
import com.hjsoftware.ptplogistics.Fragments.GoodsDeliveryOneFragment;
...
public class GoodsDeliveryActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setupToolbar();
        NavigationData[] drawerItem = new NavigationData[8];
        ...
        Fragment fragment=new GoodsDeliveryOneFragment();
        FragmentManager fragmentManager = getSupportFragmentManager();
        fragmentManager.beginTransaction().add(R.id.content_frame, fragment,"Goods delivery").commit();
        setTitle("Goods delivery");
                ...
                if (getSupportFragmentManager().getBackStackEntryCount() >0) {
                    ...
                    toolbar.setNavigationOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            fragmentTransaction.remove(getSupportFragmentManager().findFragmentByTag("Goods delivery"));
    ...
    private void selectItem(int position) {
        ...
        switch (position) {
            case 0:
                ...
                Intent k=new Intent(GoodsDeliveryActivity.this,HomeActivity.class);
                ...
                break;
            case 1:
                Intent l=new Intent(GoodsDeliveryActivity.this,LoadingSheetActivity.class);
            ...
            case 2:
                Intent m=new Intent(GoodsDeliveryActivity.this,UnLoadingSheetActivity.class);
                ...
                break;
            case 3 :
                Intent n=new Intent(GoodsDeliveryActivity.this,GoodsDeliveryActivity.class);
            ...
            case 4:
                Intent o=new Intent(GoodsDeliveryActivity.this,LRCancelActivity.class);
                ...
                break;
            case 5 :
                Intent p=new Intent(GoodsDeliveryActivity.this,LRTrackingActivity.class);
                ...
                break;
            case 6:
                Intent q=new Intent(GoodsDeliveryActivity.this,ChangePasswordActivity.class);
...
//sendLogoutStatus();
    ...
    {
        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(GoodsDeliveryActivity.this);
                ...
                call.enqueue(new Callback<Pojo>() {
                    ...
                    public void onResponse(Call<Pojo> call, Response<Pojo> response) {
                        if(response.isSuccessful()){
                            ...
                            finish();
                            Toast.makeText(GoodsDeliveryActivity.this, "You have successfully Logged Out!", Toast.LENGTH_SHORT).show();

                        }
                        else{
                            Toast.makeText(GoodsDeliveryActivity.this, "Error"+response.message(), Toast.LENGTH_SHORT).show();
                    ...
                    public void onFailure(Call<Pojo> call, Throwable t) {
                        Toast.makeText(GoodsDeliveryActivity.this,"Please check Internet connection!",Toast.LENGTH_LONG).show();
