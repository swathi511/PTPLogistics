...
import com.hjsoftware.ptplogistics.Fragments.UnLoadingSheetFragment;
...
public class UnLoadingSheetActivity extends AppCompatActivity {
    ...
    private void selectItem(int position) {
        ...
        switch (position) {
            case 0:
                ...
                Intent k=new Intent(UnLoadingSheetActivity.this,HomeActivity.class);
                ...
                break;
            case 1:
                Intent l=new Intent(UnLoadingSheetActivity.this,LoadingSheetActivity.class);
            ...
            case 2:
              Intent m=new Intent(UnLoadingSheetActivity.this,UnLoadingSheetActivity.class);
                ...
                break;
            case 3 :
                Intent n=new Intent(UnLoadingSheetActivity.this,GoodsDeliveryActivity.class);
            ...
            case 4:
                Intent o=new Intent(UnLoadingSheetActivity.this,LRCancelActivity.class);
                ...
                break;
            case 5 :
                 Intent p=new Intent(UnLoadingSheetActivity.this,LRTrackingActivity.class);
                ...
                break;
            case 6:
                Intent q=new Intent(UnLoadingSheetActivity.this,ChangePasswordActivity.class);
...
//sendLogoutStatus();
    ...
    {
        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(UnLoadingSheetActivity.this);
                ...
                call.enqueue(new Callback<Pojo>() {
                    ...
                    public void onResponse(Call<Pojo> call, Response<Pojo> response) {
                        if(response.isSuccessful()){
                            ...
                            finish();
                            Toast.makeText(UnLoadingSheetActivity.this, "You have successfully Logged Out!", Toast.LENGTH_SHORT).show();

                        }
                        else{
                            Toast.makeText(UnLoadingSheetActivity.this, "Error"+response.message(), Toast.LENGTH_SHORT).show();
                    ...
                    public void onFailure(Call<Pojo> call, Throwable t) {
                        Toast.makeText(UnLoadingSheetActivity.this,"Please check Internet connection!",Toast.LENGTH_LONG).show();
