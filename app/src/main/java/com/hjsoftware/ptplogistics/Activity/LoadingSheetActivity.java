...
import com.hjsoftware.ptplogistics.Fragments.LoadingSheetFragment;
...
public class LoadingSheetActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Fragment fragment=new LoadingSheetFragment();
    ...
    private void selectItem(int position) {
        ...
        switch (position) {
            case 0:
                ...
                Intent k=new Intent(LoadingSheetActivity.this,HomeActivity.class);
                ...
                break;
            case 1:
              Intent l=new Intent(LoadingSheetActivity.this,LoadingSheetActivity.class);
            ...
            case 2:
              Intent m=new Intent(LoadingSheetActivity.this,LoadingSheetActivity.class);
                ...
                break;
            case 3 :
                Intent n=new Intent(LoadingSheetActivity.this,GoodsDeliveryActivity.class);
            ...
            case 4:
                Intent o=new Intent(LoadingSheetActivity.this,LRCancelActivity.class);
                ...
                break;
            case 5 :
                 Intent p=new Intent(LoadingSheetActivity.this,LRTrackingActivity.class);
                ...
                break;
            case 6:
                Intent q=new Intent(LoadingSheetActivity.this,ChangePasswordActivity.class);
...
//sendLogoutStatus();
    ...
    {
        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(LoadingSheetActivity.this);
                ...
                call.enqueue(new Callback<Pojo>() {
                    ...
                    public void onResponse(Call<Pojo> call, Response<Pojo> response) {
                        if(response.isSuccessful()){
                            ...
                            finish();
                            Toast.makeText(LoadingSheetActivity.this, "You have successfully Logged Out!", Toast.LENGTH_SHORT).show();

                        }
                        else{
                            Toast.makeText(LoadingSheetActivity.this, "Error"+response.message(), Toast.LENGTH_SHORT).show();
                    ...
                    public void onFailure(Call<Pojo> call, Throwable t) {
                        Toast.makeText(LoadingSheetActivity.this,"Please check Internet connection!",Toast.LENGTH_LONG).show();
