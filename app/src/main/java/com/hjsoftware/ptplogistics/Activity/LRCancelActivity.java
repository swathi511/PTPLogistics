...
import com.hjsoftware.ptplogistics.Fragments.LRCancelOneFragment;
...
public class LRCancelActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Fragment fragment=new LRCancelOneFragment();
        FragmentManager fragmentManager = getSupportFragmentManager();
        fragmentManager.beginTransaction().add(R.id.content_frame, fragment,"LR Cancel").commit();
        setTitle("LR Cancel");
                ...
                if (getSupportFragmentManager().getBackStackEntryCount() >0) {
                    ...
                    toolbar.setNavigationOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            fragmentTransaction.remove(getSupportFragmentManager().findFragmentByTag("LR Cancel"));
    ...
    private void selectItem(int position) {
        ...
        switch (position) {
            case 0:
                ...
                Intent k=new Intent(LRCancelActivity.this,HomeActivity.class);
                ...
                break;
            case 1:
                Intent l=new Intent(LRCancelActivity.this,LoadingSheetActivity.class);
            ...
            case 2:
              Intent m=new Intent(LRCancelActivity.this,UnLoadingSheetActivity.class);
                ...
                break;
            case 3 :
                Intent n=new Intent(LRCancelActivity.this,GoodsDeliveryActivity.class);
            ...
            case 4:
                Intent o=new Intent(LRCancelActivity.this,LRCancelActivity.class);
                ...
                break;
            case 5 :
                 Intent p=new Intent(LRCancelActivity.this,LRTrackingActivity.class);
                ...
                break;
            case 6:
                Intent q=new Intent(LRCancelActivity.this,ChangePasswordActivity.class);
...
//sendLogoutStatus();
    ...
    {
        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(LRCancelActivity.this);
                ...
                call.enqueue(new Callback<Pojo>() {
                    ...
                    public void onResponse(Call<Pojo> call, Response<Pojo> response) {
                        if(response.isSuccessful()){
                            ...
                            finish();
                            Toast.makeText(LRCancelActivity.this, "You have successfully Logged Out!", Toast.LENGTH_SHORT).show();

                        }
                        else{
                            Toast.makeText(LRCancelActivity.this, "Error"+response.message(), Toast.LENGTH_SHORT).show();
                    ...
                    public void onFailure(Call<Pojo> call, Throwable t) {
                        Toast.makeText(LRCancelActivity.this,"Please check Internet connection!",Toast.LENGTH_LONG).show();
