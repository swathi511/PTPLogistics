...
import com.hjsoftware.ptplogistics.Fragments.LRTrackingFragment;
 ...
 */
public class LRTrackingActivity extends AppCompatActivity {
    ...
    private void selectItem(int position) {
        ...
        switch (position) {
            case 0:
                ...
                Intent k=new Intent(LRTrackingActivity.this,HomeActivity.class);
                ...
                break;
            case 1:
                Intent r=new Intent(LRTrackingActivity.this,BookingListActivity.class);
                ...
                break;
            case 2:
                Intent l=new Intent(LRTrackingActivity.this,LRTrackingActivity.class);
            ...
            case 3:
                Intent m=new Intent(LRTrackingActivity.this,LRPODUpdateActivity.class);
                ...
                break;
            /*case 3 :
                Intent n=new Intent(LRTrackingActivity.this,GoodsDeliveryActivity.class);
            ...
            case 4:
                Intent o=new Intent(LRTrackingActivity.this,LRCancelActivity.class);
                ...
                break;
             case 5 :
                 Intent p=new Intent(LRTrackingActivity.this,LRTrackingActivity.class);
                ...
                finish();
                 break;*/
            case 4:
                Intent q=new Intent(LRTrackingActivity.this,ChangePasswordActivity.class);
...
//sendLogoutStatus();
    ...
    {
        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(LRTrackingActivity.this);
                ...
                call.enqueue(new Callback<Pojo>() {
                    ...
                    public void onResponse(Call<Pojo> call, Response<Pojo> response) {
                        if(response.isSuccessful()){
                            ...
                            finish();
                            Toast.makeText(LRTrackingActivity.this, "You have successfully Logged Out!", Toast.LENGTH_SHORT).show();

                        }
                        else{
                            Toast.makeText(LRTrackingActivity.this, "Error"+response.message(), Toast.LENGTH_SHORT).show();
                    ...
                    public void onFailure(Call<Pojo> call, Throwable t) {
                        Toast.makeText(LRTrackingActivity.this,"Please check Internet connection!",Toast.LENGTH_LONG).show();
