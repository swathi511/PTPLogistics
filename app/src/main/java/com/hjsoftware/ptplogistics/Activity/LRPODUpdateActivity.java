...
import com.hjsoftware.ptplogistics.Fragments.LRPODUpdateFragment;
 ...
 */
public class LRPODUpdateActivity extends AppCompatActivity {
    ...
    private void selectItem(int position) {
        ...
        switch (position) {
            case 0:
                ...
                Intent k=new Intent(LRPODUpdateActivity.this,HomeActivity.class);
                ...
                break;
            case 1:
                Intent r=new Intent(LRPODUpdateActivity.this,BookingListActivity.class);
                ...
                break;
            case 2:
                Intent l=new Intent(LRPODUpdateActivity.this,LRTrackingActivity.class);
            ...
            case 3:
                Intent m=new Intent(LRPODUpdateActivity.this,LRPODUpdateActivity.class);
                ...
                break;
            /*case 3 :
                Intent n=new Intent(LRPODUpdateActivity.this,GoodsDeliveryActivity.class);
            ...
            case 4:
                Intent o=new Intent(LRPODUpdateActivity.this,LRCancelActivity.class);
                ...
                break;
             case 5 :
                 Intent p=new Intent(LRPODUpdateActivity.this,LRTrackingActivity.class);
                ...
                finish();
                 break;*/
            case 4:
                Intent q=new Intent(LRPODUpdateActivity.this,ChangePasswordActivity.class);
...
//sendLogoutStatus();
    ...
    {
        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(LRPODUpdateActivity.this);
                ...
                call.enqueue(new Callback<Pojo>() {
                    ...
                    public void onResponse(Call<Pojo> call, Response<Pojo> response) {
                        if(response.isSuccessful()){
                            ...
                            finish();
                            Toast.makeText(LRPODUpdateActivity.this, "You have successfully Logged Out!", Toast.LENGTH_SHORT).show();

                        }
                        else{
                            Toast.makeText(LRPODUpdateActivity.this, "Error"+response.message(), Toast.LENGTH_SHORT).show();
                    ...
                    public void onFailure(Call<Pojo> call, Throwable t) {
                        Toast.makeText(LRPODUpdateActivity.this,"Please check Internet connection!",Toast.LENGTH_LONG).show();
