...
import com.hjsoftware.ptplogistics.Fragments.BookingListFragment;
...
public class BookingListActivity extends AppCompatActivity implements BookingAdapter.AdapterCallback{
    ...
    public void onMethodCallback(String bookingId) {
        ...
        Intent i=new Intent(BookingListActivity.this,LREditActivity.class);
        i.putExtra("lr",bookingId);
        startActivity(i);
        finish();
    }
    ...
    private void selectItem(int position) {
        ...
        switch (position) {
            case 0:
                ...
                break;
            case 1:
                Intent r=new Intent(BookingListActivity.this,BookingListActivity.class);
                ...
                break;
            case 2:
                Intent l=new Intent(BookingListActivity.this,LRTrackingActivity.class);
            ...
            case 3:
                Intent m=new Intent(BookingListActivity.this,LRPODUpdateActivity.class);
                ...
                break;
            /*case 3 :
                Intent n=new Intent(BookingListActivity.this,GoodsDeliveryActivity.class);
            ...
            case 4:
                Intent o=new Intent(BookingListActivity.this,LRCancelActivity.class);
                ...
                break;
             case 5 :
                 Intent p=new Intent(BookingListActivity.this,LRTrackingActivity.class);
                ...
                finish();
                 break;*/
            case 4:
                Intent q=new Intent(BookingListActivity.this,ChangePasswordActivity.class);
...
//sendLogoutStatus();
    ...
    {
        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(BookingListActivity.this);
                ...
                call.enqueue(new Callback<Pojo>() {
                    ...
                    public void onResponse(Call<Pojo> call, Response<Pojo> response) {
                        if(response.isSuccessful()){
                            ...
                            finish();
                            Toast.makeText(BookingListActivity.this, "You have successfully Logged Out!", Toast.LENGTH_SHORT).show();

                        }
                        else{
                            Toast.makeText(BookingListActivity.this, "Error"+response.message(), Toast.LENGTH_SHORT).show();
                    ...
                    public void onFailure(Call<Pojo> call, Throwable t) {
                        Toast.makeText(BookingListActivity.this,"Please check Internet connection!",Toast.LENGTH_LONG).show();
